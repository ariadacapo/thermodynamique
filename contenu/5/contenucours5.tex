...
\section{Quantification des propriétés de l’eau}
	...
	\subsection{Points de saturation}
		...
		\caption{Extrait de l’abaque~n°2. L’indice $L$ correspond au liquide saturé, et l’indice $V$ correspond à la vapeur saturée. Les indices $LV$ correspondent à la différence entre ces valeurs : par exemple $v_{LV} \equiv v_V - v_L$.}
