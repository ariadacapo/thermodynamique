\section{Ébullition et liquéfaction}
	...
	\subsection{Qu’est-ce qu’un liquide ?}
		...
		\thermoquotebegin{O}
La vapeur n’est ici qu’un moyen de transporter le calorique ; elle remplit le même office que dans le chauffage des bains par la vapeur, à l’exception près que dans le cas où nous sommes son mouvement est rendu utile.
...
\section{Description qualitative des propriétés de l’eau}
	...
	\subsection{Les limites du gaz parfait}
		...
		\thermoquotebegin{O}
		Les gaz font preuve dans leur comportement, en particulier dans les relations de volume, température et de pression exprimées par les lois de Mariotte et Gay-lussac, de tant de régularité qu’ils nous amènent cette notion : l’attraction mutuelle des particules, qui a lieu dans les corps solides et fluides, est annulée dans leur cas ; de sorte que bien qu’avec les solides et liquides la chaleur nécessaire pour provoquer une expansion doive surmonter une résistance interne et une résistance externe, seule la seconde a un effet dans le cas des gaz.
		% la fin de la phrase est lourde, à reformuler, en particulier à cause de la collision "de sorte que + bien que" à mon avis
	...
	\subsection{Le diagramme température-volume ($T$-$v$)}
		...
		\thermoquotebegin{O}
		La vapeur peut être considérée à l’instant même de sa formation dans la chaudière et encore en contact avec le liquide dont elle émane, ou bien séparée de ce même liquide ; selon chacun de ces cas, ses propriétés sont différentes.
	...
	\subsection{Pièges pour l’étudiant/e}
		...
		%un doute à la lecture sur l'adéquation du verbe "dicte" ici. 
...
%exo_ à quelle pression faut-il porter l’eau pour qu’elle reste liquide à~150°C ?
	...
	\subsection{Le mélange liquide-vapeur}
		...
		Nous pouvons maintenant utiliser les mêmes abaques~n°2 et~n°3 pour quantifier ce qui se passe entre les points de saturation.
			...
			%http://www.projet-voltaire.fr/blog/regle-orthographe/trois-quarts-ou-trois-quarts
