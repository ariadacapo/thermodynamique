...
\section{Description qualitative des propriétés de l’eau}
	...
	\label{ch_lv_diagramme_tv}
		...
		Dans cet état, la substance est appelée \vocab{mélange liquide-vapeur}\index{liquide-vapeur, mélange}\footnote{Rigoureusement, le mélange est nommé \vocab{mélange liquide-vapeur saturé}\index{saturé, mélange liquide-vapeur}, puisqu’il est composé de \vocab{liquide saturé}\index{saturé, liquide}\index{liquide!saturé} (parfois dit \vocab[saturant, liquide]{saturant}\index{liquide!saturant}) et de \vocab{vapeur saturée}\index{saturée, vapeur}\index{vapeur!saturée} (parfois dite \vocab[saturante, vapeur]{saturante}\index{vapeur!saturante}). En anglais : \vocabe{wet vapour}.}\nolinebreak.
		...
		Au final, on peut relier entre eux tous les points de changement de phase, à toutes les pressions différentes : on obtient une courbe nommée \vocab{courbe de saturation}\index{saturation, courbe de}\footnote{La \vocab{courbe de saturation} est parfois divisée arbitrairement en deux parties nommées \vocab{courbe de rosée}\index{rosée, courbe de} à droite et \vocab{courbe d’ébullition}\index{ébullition, courbe de} à gauche.}. Toutes ces informations peuvent être regroupées sur un diagramme température-volume ($T$-$v$) représenté en \cref{fig_t-v_eau}, qui décrit bien les propriétés des mélanges liquide-vapeur. L’étudiant/e est encouragé/e à s’entraîner à le reproduire.
