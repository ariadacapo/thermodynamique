...
\section{Description qualitative des propriétés de l’eau}
	...
	\label{ch_lv_diagramme_tv}
		...
		\thermoquoteend{François-Marie Guyonneau de~Pambour, 1835}{\textit{Traité théorique et pratique des machines locomotives}~\cite{pambour1835}\onlyamphibook{\vspace{4em}}\onlyframabook{\vspace{1em}}} %handmade vspace
