...
\label{ch_cheval_vapeur}\index{cheval-vapeur (unité)}\index{liquides-vapeurs!utilisation industrielle}
	...
	\onlyframabook{\begin{figure}}
		\begin{center}
			...
			\supercaption{Schéma de coupe d’un des premiers moteurs à vapeur (moteur Newcomen, \texttildelow 1720). La condensation provoquée par injection d’eau dans le cylindre provoquait une chute de pression interne.\index{Newcomen, moteur}\index{moteur!Newcomen}}{\wcfile{Newcomen6325.png}{Dessin \pd par Newton Henry Black \& Harvey Nathaniel Davis}, publié en 1913}
			\label{fig_newcomen}
		\end{center}
	\end{figure}
	...
	\index{atmosphère, pression de l’}\index{pression!atmosphérique}
	...
	\end{center}
	\supercaption{Le moteur de \textit{Boulton \& Watt} avec condensation séparée et piston double-face.\index{moteur!de Boulton \& Watt}}{\wcfile{SteamEngine_Boulton\%26Watt_1784.png}{Dessin} \pd par Robert Henry Thurston (1878)}
	...
	\index{cheval-vapeur (unité)}\index{Watt!unité}
