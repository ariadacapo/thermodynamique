...
\label{exo_temperature_pression_ebullition}
	...
	\begin{figure}[htp] %handmade
		...
		\end{center}
		\supercaption{Boisson chaude aérienne au goût non identifié.}{\flickrfile{notbrucelee/7942977960}{photo} \ccby par \flickruser{notbrucelee}}
		\label{fig_cafe}
	\end{figure}
...
\label{exo_evaporation_eau}
	...
	\begin{figure}[htp] %handmade
		...
		\end{center}
		\supercaption{Expérience de physique ordinaire}{\flickrfile{indi/2391675917}{photo} \ccby par \flickrname{indi}{Indi Samarajiva}}
...
\label{exo_moteur_basique_vapeur}
	...
	\begin{figure}[htp] %handmade
		...
		\end{center}
		\supercaption{Un concept très simple de moteur à vapeur}{schéma \cczero \olivier}
...
\label{exo_pompage_baliani}
	...
	\begin{figure}[htp] %handmade
		...
		\end{center}
		\supercaption{Pompage d’un réservoir d’eau situé en contrebas. La première observation de la limite de hauteur calculée dans cet exercice est faite en 1630 par \wf{Giovanni Battista Baliani}\index{Baliani, Giovanni Battista}.}{schéma \cczero \oc}
		\label{fig_pompage}
	\end{figure}
...
\label{exo_moteur_newcomen}\index{moteur!Newcomen}\index{Newcomen, moteur}
	...
	\onlyframabook{\begin{figure}[htc]}%handmade
		\begin{center}
			...
			\onlyamphibook{\includegraphics[width=9cm]{images/moteur_newcomen_2.png}}
			\onlyframabook{\includegraphics[width=0.9\columnwidth]{images/moteur_newcomen_2.png}}%handmade
		\end{center}
...
\label{exo_condenseur_riviere}\index{condenseur}
...
\label{exo_catapulte}
	...
	\begin{figure}[htc]
		\begin{center}
			...
			\onlyframabook{\vspace{-0.6cm}}%handmade
		\end{center}
		\supercaption{Cylindre d’une catapulte à vapeur du \textit{USS Abraham Lincoln}}{\wcfile{Catapulte CVN72 071117-N-9898L-006.jpg}{Photo} \pd par Geoffrey Lewis, U.S. Navy}
	...
	\begin{figure}[htc]
		\begin{center}
			...
			\onlyframabook{\\\vspace{-0.6cm}}%handmade
		\end{center}
		\supercaption{Piston d’une catapulte à vapeur du porte-avions \textit{Charles de Gaulle}.}{\wcfile{French aircraft carrier Charles de Gaulle - catapult maintenance 2008.jpg}{Photo} \ccbysa par Jean-Michel Roche, Netmarine.net}
...
\begin{description}
	...
	\item [\ref{exo_moteur_basique_vapeur}]
			...
			\tab 4) Les relations sont identiques et donnent ${W}_{\B \to \E} = \SI{-899,6}{\kilo\joule}$ et ${Q}_{\B \to \E} = \SI{+7694,3}{\kilo\joule}$ (l’efficacité bondit de \num{3,8} à~\SI{11,7}{\percent}… il y a là une piste à suivre…)
