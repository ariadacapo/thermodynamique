...
\index{moteur!à vapeur, composants des}
	...
	\label{ch_expressions_puissances_vapeur}
		...
		\begin{itemize}\index{isothermes, évolutions}\index{évolutions!isothermes}\index{isentropiques, évolutions}\index{évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{évolutions!adiabatiques réversibles}\index{travail!transferts réversibles}
