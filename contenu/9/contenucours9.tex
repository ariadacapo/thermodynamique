\index{cycle!moteur à vapeur|(textbf}\index{moteur!cycles vapeur|(textbf}\index{vapeur!cycles moteur|(textbf}\index{liquides-vapeurs!cycles moteur|(textbf}
\section{Pourquoi utiliser un moteur à vapeur ?}
	...
	\index{liquides-vapeurs!utilisation industrielle}\index{combustible}\index{chaleur!sources de}
	...
	\index{capacité!thermique volumique}
...
\label{ch_evaluation_moteurs_vapeur}\index{moteur!critères d’évaluation}
	...
	\subsection{Rendement thermique et rendement global}
		...
		\begin{itemize}
			...
			\item Dans la chaudière, le transfert énergétique depuis la source de chaleur vers l’eau peut se faire incomplètement (une partie de la chaleur étant éventuellement perdue avec les gaz d’échappement), ce que nous pouvons évaluer avec une efficacité $\eta_\text{chaudière}$ ;\index{efficacité!d’une chaudière}
			...
			\item La génération de puissance électrique à partir de travail mécanique se fait elle aussi avec des pertes aboutissant à la production de chaleur, que nous évaluons avec une efficacité $\eta_\text{génératrice}$.\index{efficacité!d’une génératrice}
		\end{itemize}
	...
	\index{ecologique@écologique, impact}\index{environnement, impact sur}\index{chaleur!sources de}\index{combustible}
...
\section{Composants des installations à vapeur}
	...
	\label{ch_expressions_puissances_vapeur}
		...
		\begin{itemize}\index{isothermes, évolutions}\index{evolutions@évolutions!isothermes}\index{isentropique(s)!évolutions}\index{evolutions@évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{evolutions@évolutions!adiabatiques réversibles}\index{travail!transferts réversibles}
...
\onlyamphibook{%handmade aaaaannnnnd... this is how it’s done:
		...
		L’efficacité d’une turbine se mesure en comparant sa puissance avec celle d’une turbine idéale (une turbine qui serait isentropique). Nous nommons ce paramètre l’\vocab[efficacité!isentropique]{efficacité isentropique}\index{turbine!efficacité isentropique}\index{isentropique(s)!efficacité} $\eta_\text{T}$ :
		\begin{equation}
		...
		\index{courbe!de saturation}\index{saturation!courbe de}\index{titre}\index{vapeur!titre de}
	...
	\index{condenseur|(textbf}
		...
		\begin{figure}
			\begin{center}
				\onlyamphibook{\includegraphics[width=0.6\textwidth]{images/cooling_towers.jpg}}
				\onlyframabook{\includegraphics[width=0.55\textwidth]{images/cooling_towers.jpg}}
			\end{center}
		...
		\index{température!minimale d’un moteur}\index{moteur!température minimale d’un}\index{pression!atmosphérique}\index{atmosphère, pression de l’}
...
\label{ch_cycles_moteurs_vapeur}
	...
	\label{ch_cycle_de_rankine}\index{Rankine!cycle de}\index{cycle!de Rankine}
		...
		\index{efficacité!d’une chaudière}\index{efficacité!d’un moteur}\index{moteur!rendement d’un}\index{chaudière!efficacité}
	...
	\label{ch_regeneration}\index{regeneration@régénération (procédé)}
		...
		\index{Carnot!cycle de}\index{cycle!de Carnot}\index{efficacité!d’un moteur}\index{efficacité!maximale d’un moteur}\index{moteur!rendement maximal d’un}
		...
		\index{chaleur!transferts réversibles}\index{titre}\index{vapeur!titre de}
		...
		\clearfloats
		En pratique, de nombreux prélèvements\index{turbine!prélèvement}\index{prélèvement!en turbine} (judicieusement appelés \vocabe{bleeds}, ou «~saignements~» en anglais) sont effectués dans les circuits de centrale à vapeur, pour contrôler les flux de chaleur (\cref{fig_grosse_centrale_vapeur}). Ils permettent accessoirement, par le biais de vannes de décharge, de réguler précisément les débits de masse et adapter ainsi rapidement la puissance de l’installation à la demande.
