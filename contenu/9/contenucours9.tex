...
\label{ch_cycles_moteurs_vapeur}
	...
	\label{ch_regeneration}
		...
		\begin{figure}
			...
			\end{center}
			\caption{Circuit d’une centrale à vapeur avec régénération. On prélève de la chaleur à la turbine pour réchauffer l’eau liquide avant qu’elle ne pénètre dans la chaudière. Idéalement, le transfert de chaleur se fait de façon réversible.}
