...
\section{Composants des installations à vapeur}
	...
	\subsection{Turbine}
		...
		\begin{equationterms}
			...
			\item où \tab $\dot{W}_\text{turbine réelle}$ 		\tab\tab\tab\tab est la puissance réelle fournie par la turbine,
