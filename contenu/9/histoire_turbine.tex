...
\label{ch_histoire_turbine}\index{turbine!histoire}\index{turbomachine (moteur à turbine)!histoire}

\index{Turbinia (navire)}\index{Parsons, Charles Algernon}
Au début du \textsc{xx}\ieme siècle, la \vocab[turbomachine (moteur à turbine)!histoire]{turbine} a remplacé les pistons et cylindres dans tous les moteurs à vapeur. 
...
\index{efficacité!isentropique}\index{turbine!efficacité isentropique}\index{compresseur!efficacité isentropique}\index{efficacité!d’un compresseur}\index{efficacité!d’une turbine}
