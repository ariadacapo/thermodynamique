...
\index{Rankine!cycle surchauffé de}\index{cycle!de Rankine surchauffé}\index{surchauffe (procédé)}
...
\index{Rankine!cycle resurchauffé de}\index{cycle!de Rankine resurchauffé}\index{resurchauffe (procédé)}
...
\label{exo_brise_glace}\index{regeneration@régénération (procédé)}\index{surchauffe (procédé)}\index{Rankine!cycle surchauffé de}\index{cycle!de Rankine surchauffé}
...
\titreresultats
	...
	\begin{description}
		\item [\ref{exo_porcheville_rankine}]
						\tab 1) Voir les figures~\ref{fig_cycle_rankine_surchauffe} et~\ref{fig_ts_lv_rankine_surchauffe} p.\pageref{fig_ts_lv_rankine_surchauffe} ;
