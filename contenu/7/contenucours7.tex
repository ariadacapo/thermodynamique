...
\section{Le second principe}
	...
	\label{ch_second_principe_enonce}
		...
		Le \vocab[principes de la thermodynamique!second, énoncé]{second principe de la thermodynamique} s’exprime ainsi :
...
\label{ch_cycle_de_carnot}\index{Carnot!cycle de|(textbf}\index{cycle!de Carnot|(textbf}
	...
	\label{ch_elaboration_cycle_carnot}
		...
		\index{évolutions!isentropiques}\index{isentropiques, évolutions}\index{évolutions!adiabatiques réversibles}\index{adiabatiques!réversibles, évolutions}\index{évolutions!isothermes}\index{isothermes, évolutions}
		\begin{enumerate}
	...
	\label{ch_descritpion_cycle_carnot}
		...
		\begin{itemize}
			...
			\item \textbf{Compression adiabatique réversible de 1 à 2}
				\index{évolutions!isentropiques}\index{isentropiques, évolutions}\index{évolutions!adiabatiques réversibles}\index{adiabatiques!réversibles, évolutions}
...
\index{température!échelle de|(textbf}\index{température!thermodynamique|(textbf}
	...
	\subsection{L’essentiel à retenir}
		...
		\index{température!selon Kelvin}\index{Kelvin!William Thomson, température selon}
...
\label{ch_efficacite_maximale_machines}\index{efficacité!maximale des machines|(}
	...
	\label{ch_efficacité_moteur_carnot}\index{efficacité!d’un moteur}\index{efficacité!maximale d’un moteur}\index{moteur!rendement maximal d’un}\index{température!maximale d’un moteur}\index{température!minimale d’un moteur}
...
\emph{La puissance motrice de la chaleur est indépendante des agens mis en œuvre pour la réaliser ; sa quantité est fixée uniquement par les températures des corps entre lesquels se fait en dernier résultat le transport du calorique}.\nolinebreak\makebox(18,5){\color{gray}\scalebox{2}{»}}\par\vspace{-0.3cm}\begin{flushright}Sadi Carnot, 1824\index{Carnot!Sadi}~\cite{carnot1824}\end{flushright}
		...
		\index{efficacité!d’un moteur}\index{efficacité!maximale d’un moteur}\index{moteur!rendement maximal d’un}\index{température!maximale d’un moteur}\index{température!minimale d’un moteur}
