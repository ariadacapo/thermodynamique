	...
	\label{ch_descritpion_cycle_carnot}
		...
		\begin{itemize}
			...
			\item \textbf{Refroidissement isotherme de 4 à~1}
				...
				En 4, le fluide est à température basse $T_{B}$. Pour le ramener à son volume initial, il faut lui retirer de la chaleur. Nous procédons à un refroidissement isotherme a lieu : le piston est avancé progressivement, et la température du fluide est maintenue constante à~$T_{TB}$.
