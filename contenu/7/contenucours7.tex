\index{principes de la thermodynamique!second|(}
...
\label{ch_second_principe_machines_thermiques}
	...
	\label{ch_limites_machines_thermiques}
		...
		\clearfloats\index{principes de la thermodynamique!second, appliqué aux réfrigérateurs (ou climatiseurs)}\index{réfrigérateur!rendement maximal d’un}\index{climatiseur!rendement maximal d’un}\index{pompe à chaleur!rendement maximal d’une}\index{cycle!de réfrigération}
...
\label{ch_cycle_de_carnot}\index{Carnot!cycle de|(}\index{cycle!de Carnot|(}
	...
	\subsection{Le réfrigérateur de Carnot}
		...
		\end{figure}
\index{cycle!de Carnot|)}\index{Carnot!cycle de|)}%whew

\section{L’échelle de température thermodynamique}
\label{ch_echelle_temperature_thermodynamique}
\index{température!échelle|(}\index{température!thermodynamique|(}
	...
	\label{thermometres_celsius_fahrenheit}
		...
		\index{Celsius!Anders|(}\index{Celsius!température selon|(}\index{température!selon Celsius|(}\index{Fahrenheit!Gabriel|(}\index{Fahrenheit!température selon|(}\index{température!selon Fahrenheit|(}
...
\index{température!échelle|)}\index{température!thermodynamique|)}%whew
