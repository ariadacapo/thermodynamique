...
\label{ch_second_principe_machines_thermiques}
	...
	\label{ch_limites_machines_thermiques}
		...
		\begin{description}
			...
			Les puristes exprimeront ce corollaire, dit \vocab[principes de la thermodynamique!second, corrolaire de Kelvin-Planck]{de Kelvin-Planck}\item{Kelvin-Planck, corrolaire de}, avec l’inéquation suivante :
			\begin{equation}
				\dot Q_{TH} > -\dot W_\net
			\end{equation}
			\begin{equationterms}
...
\label{ch_cycle_de_carnot}
	...
	\label{ch_descritpion_cycle_carnot}
		...
		\clearpage%handmade, sinon l’exemple ci-dessous insère une page vide dans le corps du texte.
		\begin{anexample}
