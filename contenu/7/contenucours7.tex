...
\label{ch_second_principe_machines_thermiques}
	...
	\label{ch_limites_machines_thermiques}
		...
		\clearfloats\index{principes de la thermodynamique!second, appliqué aux réfrigérateurs (ou climatiseurs)}\index{réfrigérateur!rendement maximal d’un}\index{efficacité!d’un réfrigérateur}\index{efficacité!maximale d’un réfrigérateur}\index{climatiseur!rendement maximal d’un}\index{efficacité!d’un climatiseur}\index{efficacité!maximale d’un climatiseur}\index{efficacité!d’une pompe à chaleur}\index{efficacité!maximale d’une pompe à chaleur}\index{pompe à chaleur!rendement maximal d’une}\index{cycle!de réfrigération (ou climatisation)}
...
\label{ch_cycle_de_carnot}\index{Carnot!cycle de|(textbf}\index{cycle!de Carnot|(textbf}
	...
	\label{ch_concept_machine_reversible}\index{réversibilité}\index{réversibilité!réversible vs. inversable}\index{inversable vs. réversible}
	...
	\label{ch_elaboration_cycle_carnot}
		...
		\index{évolutions!isentropiques}\index{isentropique(s)!évolutions}\index{évolutions!adiabatiques réversibles}\index{adiabatiques!réversibles, évolutions}\index{évolutions!isothermes}\index{isothermes, évolutions}
		\begin{enumerate}
	...
	\label{ch_descritpion_cycle_carnot}
		...
		\begin{itemize}
			...
			\item \textbf{Compression adiabatique réversible de 1 à 2}
				\index{évolutions!isentropiques}\index{isentropique(s)!évolutions}\index{évolutions!adiabatiques réversibles}\index{adiabatiques!réversibles, évolutions}
			...
			\item \textbf{Chauffage isotherme de 2 à 3}
				\index{évolutions!isothermes}\index{isothermes, évolutions}
...
\index{température!échelle de|(textbf}\index{température!thermodynamique|(textbf}
	...
	\subsection{Qu’est-ce qu’une échelle en physique ?}
		...
		\index{température!zéro}\index{échelle (physique)}
	...
	\index{température!zéro}\index{Kelvin!température selon}\index{température!selon Kelvin}\index{Celsius!température selon}\index{température!selon Celsius}%
		...
		Thomson dispose donc d’une \vocab[échelle (physique)]{échelle} —\ une méthode permettant de définir une température «~deux fois plus élevée~».
	...
	\index{température!échelle de|)textbf}\index{température!thermodynamique|)textbf}%whew
...
\emph{La puissance motrice de la chaleur est indépendante des agens mis en œuvre pour la réaliser ; sa quantité est fixée uniquement par les températures des corps entre lesquels se fait en dernier résultat le transport du calorique}.\nolinebreak\makebox(18,5){\color{gray}\scalebox{2}{»}}\par\vspace{-0.3cm}\begin{flushright}Sadi Carnot, 1824\index{Carnot!Sadi}~\cite{carnot1824}\end{flushright}
	...
	\label{ch_efficacite_refrigerateur_carnot}\index{efficacité!d’un réfrigérateur}\index{efficacité!maximale d’un réfrigérateur}\index{efficacité!d’un climatiseur}\index{efficacité!maximale d’un climatiseur}\index{climatiseur!rendement maximal d’un}\index{réfrigérateur!rendement maximal d’un}
