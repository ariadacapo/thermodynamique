...
\label{ch_efficacite_maximale_machines}\index{efficacité!maximale des machines|(}
	...
	\label{ch_efficacité_moteur_carnot}\index{efficacité!d’un moteur}\index{efficacité!maximale d’un moteur|textbf}\index{moteur!rendement maximal d’un|textbf}\index{température!maximale d’un moteur}\index{température!minimale d’un moteur}
