...
\titreresultats
	...
	\begin{description}
		...
		\item [\ref{exo_efficacite_refrigerateur_carnot}]
					...
					\tab 2) Compressions et détentes non réversibles (ainsi $w_{4\to 3} + w_{2\to 1} > 0$), en particulier si une soupape est utilisée (\S\ref{ch_principe_fonctionnement_réfrigérateur}) ; transferts de chaleur non-isothermes.
