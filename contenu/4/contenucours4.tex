...
\section{Propriétés des gaz parfaits}
	...
	\index{calorifique, capacité}\index{capacité!calorifique d’un gaz parfait}\index{chaleur!massique d’un gaz parfait}
	...
	\index{chaleur!massique, différence entre les}\index{capacité!calorifique, différence entre les}
	...
	\index{chaleur!massique, rapport entre les}\index{capacité!calorifique, rapport entre les}\index{gamma ($\gamma$) (gaz parfait)}
...
\index{température!énergie et}\index{énergie!température et}
	...
	\index{Joule!principe de}\index{Joule!loi de}\index{Joule!détente de Gay-Lussac et}\index{Gay-Lussac!détente de Joule et}
		...
		\index{énergie!interne d’un gaz parfait}\index{température!d’un gaz parfait}\index{gaz parfait!énergie interne d’un}
		Ce postulat est connu sous le nom de \vocab[Joule!loi de]{loi de Joule}\index{loi de Joule}\index{Joule!principe de} et est posé comme vrai pour tout gaz parfait. On peut le résumer ainsi :
...
La différence entre les moyennes des expansions et des expériences-témoin étant exactement telle que ce que à quoi nous avons attribué l’effet croissant de la température ambiante dans le dernier cas, nous arrivons à la conclusion qu’\emph{il n’y a pas de changement de température lorsque l’on laisse l’air se détendre d’une façon telle qu’il ne développe pas de puissance mécanique}.
	...
	\index{enthalpie!d’un gaz parfait}\index{gaz parfait!enthalpie d’un}
...
\index{évolutions!d’un gaz parfait}
