...
\section{Définition}
	...
	\index{pression!comme mesure de température}\index{manomètre!en tant que thermomètre}
		...
		\index{quantité de matière}\index{moles (quantité de matière)}\index{r (constante universelle des gaz}
	...
	\index{gaz parfait!limites de validité}\index{gaz parfait!modélisations alternatives}
	...
	\label{ch_gp_isobares}
		...
		\begin{anexample}
			...
			Combien faut-il d’énergie pour chauffer l’air dans un appartement de~\SI{30}{\metre\squared} depuis \SI{10}{\degreeCelsius} jusqu’à \SI{20}{\degreeCelsius} ?
				\begin{answer}\index{pression!atmosphérique}\index{amosphère, pression de l’}
