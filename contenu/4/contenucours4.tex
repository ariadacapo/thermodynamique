...
\section{Définition}
	...
	\index{pression!comme mesure de température}\index{manomètre!en tant que thermomètre}
		...
		L’\cref{eq_pv=RT} est nommée \vocab[équation d’état]{équation d’état des gaz parfaits}\index{loi(s)!des gaz parfaits}. Elle peut également être exprimée en fonction de la masse :
		\begin{equation}
			p V = m R T
			\label{eq_pV=mRT}
		\end{equation}
	...
	\index{gaz parfait!limites de validité}\index{gaz parfait!modélisations alternatives}\index{équation d’état!alternatives}
...
\index{température!énergie interne et}\index{énergie!interne, température et}
...
La différence entre les moyennes des expansions et des expériences-témoin étant exactement telle que ce que à quoi nous avons attribué l’effet croissant de la température ambiante dans le dernier cas, nous arrivons à la conclusion qu’\emph{il n’y a pas de changement de température lorsque l’on laisse l’air se détendre d’une façon telle qu’il ne développe pas de puissance mécanique}.
	...
	\index{gaz parfait!énergie interne d’un}\index{énergie!interne d’un gaz parfait}\index{gaz parfait!enthalpie d’un}\index{enthalpie!d’un gaz parfait}\index{température!enthalpie et}\index{enthalpie!température et}\index{température!énergie interne et}\index{énergie!interne, température et}
