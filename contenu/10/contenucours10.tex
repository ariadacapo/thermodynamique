...
\index{turbomachine (moteur à turbine)!composants}
	...
	\index{compresseur}
		...
		\index{isentropiques, évolutions}\index{évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{évolutions!adiabatiques réversibles}\index{travail!transferts réversibles}
