\index{cycle!moteur à gaz|(textbf}\index{moteur!cycles à gaz|(textbf}\index{combustion!interne, moteur à|(textbf}\index{moteur!à combustion interne|(textbf}\index{gaz!cycles moteur|(textbf}
...
Les moteurs à mouvement alternatif (souvent dits «~à pistons-cylindres~») admettent une quantité d’air finie et effectuent leur cycle thermodynamique sur cette masse. Le cycle peut être effectué de multiples fois en parallèle, et est répété plusieurs fois dans le temps pour fournir une puissance continue (un moteur automobile effectue usuellement une cinquantaine de cycles par seconde).
	...
	\label{ch_cycle_otto}\index{Otto!cycle d’|(textbf}\index{cycle!d’Otto|(textbf}
		...
		\index{évolutions!isochores}\index{isochores, évolutions}\index{isentropique(s)!évolutions}\index{évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{évolutions!adiabatiques réversibles}
...
Le combustible, ainsi, ne doit pas être précédemment mélangé à l’air, mais ce dernier doit être comprimé séparément, sinon, bien avant que la compression requise ne soit atteinte, l’allumage se produirait, et le cycle serait interrompu.
		...
		\index{isobares, évolutions}\index{évolutions!isobares}\index{isentropique(s)!évolutions}\index{évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{évolutions!adiabatiques réversibles}
...
\index{turbomachine (moteur à turbine)!composants}
	...
	\index{compresseur}
		...
		\index{isentropique(s)!évolutions}\index{évolutions!isentropiques}\index{adiabatiques!réversibles, évolutions}\index{évolutions!adiabatiques réversibles}\index{travail!transferts réversibles}
				...
				\begin{answer}
					...
					$C_\B = \left[ - 2 \ c_{p \text{(gaz)}} \ (T_\B - T_\A) - C_\A^2 \right]^{\frac{1}{2}}
							...
							= \SI{496,2}{\metre\per\second} = \SI{1786}{\kilo\metre\per\hour}$.
								\begin{remark}
									\index{irréversibilité!lors des transferts de travail}\index{pression!atmosphérique}\index{atmosphère, pression de l’}\index{compressibilité des écoulements}\index{écoulements compressibles}
...
\index{turbomachine (moteur à turbine)!modification des cycles|(}\index{cycle!des turbomachines, modifications|(}
