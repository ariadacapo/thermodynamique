...
\wherefrom{[partiel 2011, 6,5pts]}\index{Otto!cycle d’}\index{moteur!à essence}
...
\wherefrom{[partiel 2010, 8pts]}\index{Diesel!moteur}\index{Diesel!cycle}\index{turbocompression}\index{moteur!Diesel}
...
\wherefrom{[calqué sur partiel 2010, 7pts]}\index{turbopropulseur}
	...
	\index{prélèvement!compresseur}\index{compresseur!prélèvement}
...
\label{exo_cf6_generateur_intercooling}\index{turbomoteur}\index{intercooling}\index{axes multiples (turbomachine)}\index{turbine!multiples}
