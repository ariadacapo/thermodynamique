...
\index{système!fermé, premier principe}\index{principes de la thermodynamique!premier, système fermé}

	Le premier principe stipule que l’énergie est indestructible (\S\ref{ch_premier_principe}). Si on fournit \SI{100}{\joule} de travail à un système fermé et qu’il perd \SI{80}{\joule} sous forme de chaleur, c’est donc que «~son~» énergie a augmenté de~\SI{20}{\joule}. Nous nommons cette augmentation la \vocab[energie@énergie!interne, variation de]{variation d’énergie interne}, $\Delta U$.
...
\index{travail!calcul en système fermé}
	...
	\index{ressorts!modélisation des gaz}
		...
		\begin{description}
			...
			\index{pression!jaugée (indiquée)}\index{pression!atmosphérique}\index{atmosphère, pression de l’}
...
\onlyframabook{\clearpage}%handmade
	...
	\index{travail!en système fermé, en évolution lente}\index{système!fermé, travail en évolution lente}
		...
		\thermoquoteend{Benoît Paul Émile Clapeyron, 1834\index{Clapeyron!Benoît Paul Émile}\\ {\tiny(le premier diagramme $p-v$…)}}{\textit{Mémoire sur la puissance motrice de~la~chaleur}~\cite{clapeyron1834}\vspace{3em}}} %handmade vspace
		...
		\onlyamphibook{\thermoquotebegin{O}%handmade la citation là où elle devrait bien être.
			Cela posé, prenons un gaz quelconque à la température $T$ \jecourte; représentons son volume $v_o$ par l’abscisse \textsc{ab}, et sa pression par l’ordonnée \textsc{cb}.\jecourte Le gaz, pendant sa dilatation, aura développé une quantité d’action mécanique qui aura pour valeur l’intégrale du produit de la pression, par la différentielle du volume, et qui sera représentée géométriquement par la surface comprise entre l’axe des abscisses, les deux coordonnées \textsc{cb}, \textsc{de}, et de la portion d’hyperbole~\textsc{ce}.
		\thermoquoteend{Benoît Paul Émile Clapeyron, 1834\index{Clapeyron!Benoît Paul Émile}\index{Clapeyron!diagramme de}\\ {\tiny(le premier diagramme $p-v$…)}}{\textit{Mémoire sur la puissance motrice de~la~chaleur}~\cite{clapeyron1834}\vspace{6em}}} %handmade vspace
...
Plus on lui apporte de chaleur pendant la compression, plus la pression augmente fortement. La courbe adiabatique représente le cas où aucun apport ni perte de chaleur n’a lieu ($Q = 0$).}{schéma \cczero \oc}
	...
	\index{travail!en système fermé, en évolution rapide}\index{travail!transferts irréversibles}\index{système!fermé, travail en évolution rapide}\index{chaleur!lors des irréversibilités|(}\index{irréversibilité!concept|(}

		\thermoquotebegin{O}\index{Pambour, François-Marie Guyonneau de}
		...
		\index{chaleur!transformation de travail en}\index{chaleur!lors des irréversibilités}\index{travail!transformation en chaleur}
...
\onlyframabook{\clearpage}%handmade
	...
	\label{ch_reversibilite}\index{reversibilite@réversibilité!concept|(textbf}\index{irréversibilité!concept|(textbf}
		...
		\index{chaleur!transferts réversibles}\index{travail!transferts réversibles}
		\begin{enumerate}
	...
	\index{reversibilite@réversibilité!concept|)textbf}\index{irréversibilité!concept|)textbf}
