...
\label{ch_histoire_compound}\index{moteur!compound}\index{compound (agencement moteur)}\index{liquides-vapeurs!utilisation industrielle}
	...
	Avec un tel moteur, la marine marchande est capable d’abandonner le cabotage : elle s’empare de cette nouvelle technologie qui connaît un succès immédiat. De deux cylindres en série (\vocab[compound (agencement moteur)!double]{double compound}) on passe à trois, et même parfois quatre (\vocab[compound (agencement moteur)!quadruple]{quadruple compound} !), pour extraire de la vapeur à chaque fois plus d’énergie, sous forme de travail.
