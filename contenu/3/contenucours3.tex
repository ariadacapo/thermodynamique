...
\section{Le premier principe dans un système ouvert}
	...
	\subsection{Entrer et sortir du système : le travail d’écoulement}
		...
		Considérons le cas d’un \vocab{élément de fluide} (c’est-à-dire une petite quantité de fluide en transit, de volume $V_\text{élément}$) et qui pénètre à l’intérieur de notre système à la pression $p_1$ (\cref{fig_travail_ecoulement}).
