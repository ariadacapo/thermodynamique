...
\label{ch_conventions_compta_so}
	...
	\subsection{Le système ouvert}
		...
		\end{itemize}
		Ces systèmes sont dits en \vocab{régime continu}\footnote{On dit aussi parfois \vocab{régime permanent} ou \vocab[régime stationnaire]{stationnaire}.}.\index{continu, régime}\index{permanent, régime}\index{stationnaire, régime}
