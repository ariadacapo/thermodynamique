...
\label{ch_conventions_compta_so}
	...
	\index{système!fermé, conventions de signe}
		...
		\end{itemize}
		Ces systèmes sont dits en \vocab{régime continu}\footnote{On dit aussi parfois \vocab[régime continu]{régime permanent} ou \vocab[régime continu]{stationnaire}.\index{continu, régime}}.
...
\index{système!ouvert, premier principe}
	...
	\subsection{L’enthalpie}
		...
		Bien sûr, l’\vocab[enthalpie!définition]{enthalpie} $H$ se définit simplement comme :
		\begin{equation}
			H \equiv m \ h
		\end{equation}
		\begin{equationterms}
...
\section{Quantifier le travail avec un système ouvert}
	...
	\index{travail!en système ouvert, en évolution rapide}\index{travail!transferts iréversibles}\index{système!ouvert, travail en évolution rapide}
