...
\begin{center}\textit{Par Philippe Depondt\\ \begin{small}Université Pierre et Marie Curie, Paris\\ Contribution sous licence \ccbysa\end{small}}\end{center}
	...
	\begin{figure}
		\begin{center}
			\includegraphics[width=10cm]{images/joseph_black_calorique_latent.png}
			\supercaption{Joseph Black représenté en train de procéder à une expérience sur la chaleur latente pendant un cours universitaire à Édimbourg. On imagine qu’il n’avait aucun mal à passionner les étudiants, puisqu’il s’agit de thermodynamique…}%
