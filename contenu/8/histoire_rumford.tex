...
\label{ch_histoire_rumford_depondt}\index{chaleur!poids de la}\index{Rumford, Benjamin Thompson}\index{Thompson, Benjamin (baron Rumford)}\index{chaleur!conservation (ou non)}\index{chaleur!transformation de travail en}\index{chaleur!lors des irréversibilités}
