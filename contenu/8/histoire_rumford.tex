...
\begin{center}\textit{Par Philippe Depondt\\ \begin{small}Université Pierre et Marie Curie, Paris\end{small}}\end{center}
	...
	\onlyframabook{\begin{wrapfigure}{O}{5cm}\vspace{-\intextsep}}%handmade
	\onlyamphibook{\begin{figure}[htc]}
		\begin{center}
			...
			{\wcfile{Sir Benjamin Thompson, Count von Rumford. Stipple engraving Wellcome V0005796.jpg}{gravure} par  J. P. P. Rauschmayr, 1797 (\pd)}\vspace{-2\intextsep}
