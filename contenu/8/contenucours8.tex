...
\section{Le concept de l’entropie}
	...
	\index{évolutions!sens des}
		...
		\index{chaleur!dans les irréversibilités}
		\thermoquotebegin{O}
...
\label{ch_variations_entropie}
	...
	\index{diagramme!pression-volume}\index{diagramme!température-entropie}\index{pression-volume, diagramme}\index{température-entropie, diagramme}
		...
		\onlyamphibook{\clearfloats}\index{Carnot!cycle de}\index{diagramme!pression-volume}\index{diagramme!température-entropie}\index{pression-volume, diagramme}\index{température-entropie, diagramme}
	...
	\index{entropie!d’un liquide-vapeur, variations d’}\index{liquide-vapeur!variations d’entropie d’un}\index{abaques de vapeur}
...
\index{évolutions!sens des}
	...
	\index{irréversibilité!lors des compressions et détentes}\index{adiabatiques, évolutions}\index{adiabatiques irréversibles, évolutions}\index{chaleur!lors des irréversibilités}\index{irréversibilité!lors des transferts de travail}\index{travail!transferts irréversibles}
