...
\section{Le concept de l’entropie}
	...
	\label{ch_utilite_entropie}\index{entropie!concept}\index{énergie}
...
\section{Définition}
	...
	\label{ch_entropie_definition}\index{entropie!définition}
...
\label{ch_variations_entropie}
	...
	\index{entropie!d’un liquide-vapeur, variations d’}\index{liquides-vapeurs!variations d’entropie d’un}\index{mélange liquide-vapeur!entropie d’un}\index{abaques de vapeur}\index{liquides-vapeurs!propriétés tabulées (abaques)}
...
\index{évolutions!sens des}
	...
	\index{irréversibilité!lors des compressions et détentes}\index{adiabatiques!irréversibles, évolutions}\index{chaleur!lors des irréversibilités}\index{irréversibilité!lors des transferts de travail}\index{travail!transferts irréversibles}
