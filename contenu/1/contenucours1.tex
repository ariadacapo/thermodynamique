\section{Notion d’énergie}
	...
	\subsection{Le premier principe}
		...
		\thermoquoteend{Richard Feynman, 1963}{\textit{The Feynman Lectures on \mbox{Physics}} \mbox{\cite{feynman1963, feynman1963fr}}\onlyframabook{\vspace{-1em}}\index{Feynman, Richard}}
	...
	\index{énergie!formes}
		...
		L’\vocab[énergie!cinétique]{énergie cinétique} est possédée par un corps du fait de sa vitesse (\textit{cf.} le paragraphe \S\ref{ch_energie_mecanique} plus bas). C’est la forme d’énergie la plus facile à identifier. Elle a longtemps été nommée \textit{vis viva} («~force vive~»).
		...
		\index{énergie!interne}\index{chaleur!concept}\index{travail}\index{macroscopique, échelle}
	...
	\index{massique!énergie}\index{massique!puissance}\index{énergie!spécifique}\index{puissance!spécifique}\index{spécifique!énergie}\index{spécifique!puissance}
		...
		À cet effet, nous utilisons des grandeurs dites \vocab[spécifique!grandeur, notion de]{spécifiques} (dites parfois \mbox{\vocab[massique!grandeur, notion de]{massiques}}) ; et nous les notons en minuscules.

		\begin{description}
		
			\index{énergie!spécifique}
...
\label{ch_travail_fdl}
	...
	\index{diagramme!force-distance}\index{force-distance, diagramme}
...
% L column in tabulary solves this but tabulary precludes using arydshln
	...
	\index{chaleur!concept|textbf}
		...
		Lorsque l’on met deux corps de températures différentes en contact, leurs températures ont tendance à s’égaliser au cours d’un transfert spontané d’énergie. Nous appelons cette forme d’énergie \vocab[chaleur!concept]{chaleur}.\index{chaleur!nature de la}
