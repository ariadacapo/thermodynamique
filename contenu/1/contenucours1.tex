\section{Notion d’énergie}
	...
	\index{énergie!formes}
		...
		\index{énergie!interne}\index{chaleur}\index{travail}\index{macroscopique, échelle}
...
\section{La chaleur}
	...
	\label{ch_définition_température_cours1}
		...
		\index{température!zéro}\index{température!maximale}
...
% L column in tabulary solves this but tabulary precludes using arydshln
	...
	\index{chaleur}
		...
		Lorsque l’on met deux corps de températures différentes en contact, leurs températures ont tendance à s’égaliser au cours d’un transfert spontané d’énergie. Nous appelons cette forme d’énergie \vocab{chaleur}.\index{chaleur!nature de la}
