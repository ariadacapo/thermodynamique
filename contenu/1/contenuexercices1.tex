...
\label{exo_refroidissement_centrale_vapeur}
	...
	Le circuit suivi par l’eau dans les centrales à vapeur peut être représenté de façon simplifiée de la façon suivante (\cref{fig_cycle_rankine_chap_un}) :
			...
			Ce circuit, nommé cycle de Rankine, est étudié de façon plus approfondie au \coursneuf (\cref{ch_cycle_de_rankine}).}{schéma \ccbysa \olivier}
...
\label{exo_cric}
	...
	\begin{figure}
		...
		\end{center}
		\supercaption{Schéma de principe d’un cric hydraulique.}{schéma \cczero \oc}%FIXME: vérifier seuil d’admissibilité, cette figure est probablement repiquée de Çengel & al 2007
		\label{fig_cric}
	\end{figure}
