...
\index{thermomètre! genèse}\index{atmosphère, pression de l’}\index{pression!atmosphérique}
...
\begin{minipage}[b]{0.45\linewidth}
	...
	\end{center}
	\captionsetup{singlelinecheck=off}\index{atmosphère, pression de l’}\index{pression!atmosphérique}
...
\onlyamphibook{%handmade aaaaannnnnd... this is how it’s done:
	\begin{figure}
		...
		\end{center}
		\supercaption{Thermomètre à air du début du \textsc{xvii}\ieme siècle. La boule est emplie de gaz dont le volume varie avec sa température, repoussant l’eau du réservoir en dessous dont la surface est à pression atmosphérique. Le liquide peut être coloré, et ses variations de hauteur sont mesurées au moyen d’une graduation. La pression atmosphérique variant avec les conditions météorologiques, elle affecte les mesures : c’est, en quelque sorte, un baro-thermomètre.\index{atmosphère, pression de l’}\index{pression!atmosphérique}}{Gravure par Robert Fludd (1626, \pd), sélectionnée par Lamouline 2005~\cite{lamouline2005}}
		\label{fig_thermometre_air}
	\end{figure}
	...
	\begin{figure}
		...
		\end{center}
		\supercaption{Thermomètre médical du début du \textsc{xvii}\ieme siècle. La boule de gaz était mise en bouche par le patient. On se doute que la sensibilité du thermomètre à la pression atmosphérique n’était pas le plus gros obstacle à son adoption…\index{atmosphère, pression de l’}\index{pression!atmosphérique}}{Dessin par Santori \& Avicenne (\textit{Commentaria in primam Fen primi libri Canonis Avicennae}, 1625, \pd), sélectionné par Lamouline 2005~\cite{lamouline2005}}
		\label{fig_thermometre_medical}
	\end{figure}
}%fin onlyamphibook
	...
	\index{température!zéro}\index{température!échelle de}\index{Amontons, Guillaume}\index{atmosphère, pression de l’}\index{pression!atmosphérique}
...
\index{Réaumur, René-Antoine Ferchault de}\index{Fahrenheit!Daniel Gabriel}\index{Celsius!Anders}
