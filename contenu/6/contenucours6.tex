...
\section{Transformer chaleur et travail}
	...
	\label{ch_principe_fonctionnement_réfrigérateur}\index{réfrigérateur!principe de fonctionnement}\index{pompe à chaleur!principe de fonctionnement}\index{chaleur!transfert vers une température plus haute}\index{cycle!de réfrigération (ou climatisation)}
