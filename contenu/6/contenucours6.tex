...
\section{Transformer chaleur et travail}
	...
	\label{ch_principe_fonctionnement_réfrigérateur}
		...
		\onlyframabook{\begin{figure}[h!]}
			...
			\begin{description}
				\item[Les pompes à chaleur]\index{pompe à chaleur} appelées aussi \vocab[thermopompe]{thermopompes} (\cref{fig_agencement_thermopompe}) sont agencées de façon à rejeter la chaleur vers un corps à haute température, le plus souvent une habitation ;
		...
		\onlyframabook{\begin{figure}[h!]}
				\begin{center}
					...
					\onlyframabook{\includegraphics[width=0.8\textwidth]{images/agencement_thermopompe.png}}
				\end{center}
		...
		\onlyframabook{\begin{figure}[h!]}
				\begin{center}
					...
					\onlyframabook{\includegraphics[width=0.8\textwidth]{images/agencement_refrigerateur_climatiseur.png}}
				\end{center}
...
\section{Rendement des cycles}
	...
	\label{ch_rendement_réfrigérateur}
		...
		D’après la définition~\ref{def_efficacité_machines_thermiques} le rendement (dit aussi parfois \vocab[coefficient of performance (COP)]{coefficient of performance}\index{COP}, ou $\textsc{cop}_\text{réfrigération}$) d’un réfrigérateur ou d’un climatiseur est donc :
		\begin{equation}
