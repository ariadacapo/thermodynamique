...
\label{exo_refrigeration_soufflerie}
	...
	Les parois de la soufflerie sont fortement isolées, de sorte que ses transferts thermiques avec l’extérieur sont négligeables devant les autres transferts énergétiques. Le système de refroidissement de l’azote a un \textsc{cop} de~\num{0,8}. 
...
\begin{description}
	...
	\item [\ref{exo_generatrice_electricite_turbine}] 
			\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_turbomoteur_1.png}
			\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_turbomoteur_2.png}
	...
	\item [\ref{exo_centrale_vapeur_cycle}] 
			\includegraphics[height=\solutiondiagramwidth]{images/ex_tv_moteur_vapeur.png}
			\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_moteur_vapeur.png}
			...
			\tab 2)	$h_\A = h_{L \SI{0,5}{\bar}}$ ; 
						$h_\B = h_\A + \int_\A^\B v \diff p = h_\A + v_L \Delta p $ (\ref{eq_lv_so_travail_isochore} \& \label{eq_lv_so_chaleur_isochore} avec $q_\fromatob = 0$) ;
	...
	\item [\ref{exo_fonctionnement_climatiseur}]
				\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_climatiseur.png}
				\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_thermopompe.png}
				...
				\tab\tab 7) En principe il suffit d’inverser la position du compresseur et de la turbine. Il faudra, en pratique, également décaler les plages de températures pour permettre l’absorption de chaleur par temps froid.
	\item[\ref{exo_pack_conditonnement}]
			\includegraphics[width=0.9\textwidth]{images/ex_circuit_acm.png}\onlyamphibook{\\}
			\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_pack_1.png}
			\includegraphics[height=\solutiondiagramwidth]{images/ex_pv_pack_2.png}
			\includegraphics[width=\solutiondiagramwidth]{images/ex_pv_pack_3.png}
