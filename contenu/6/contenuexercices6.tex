...
\subsubsection[Fonctionnement d’une pompe à chaleur]{\onlyframabook{\hspace{-0.5em}}Fonctionnement d’une pompe à chaleur}%handmade un peu pourri
...
\label{exo_centrale_vapeur_cycle}\index{cycle!de Rankine}\index{Rankine!cycle de}
...
\label{exo_fonctionnement_climatiseur}\index{cycle!de réfrigération (ou climatisation)}\index{climatiseur}\index{réversibilité!réversible vs. inversable}\index{inversable vs. réversible}
...
\label{exo_pack_conditonnement}\index{pack de conditionnement}\index{cycle!de réfrigération (ou climatisation)}\index{climatiseur}\index{pompe à chaleur}
