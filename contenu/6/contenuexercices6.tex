...
\label{exo_fonctionnement_climatiseur}\index{cycle!de réfrigération (ou climatisation)}\index{climatiseur}\index{réversible vs. inversable}\index{inversable vs. réversible}
